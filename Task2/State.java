...
class State extends GlobalSimulation{
	...
	private final double x_A = 0.002, x_B = 0.004, interval_measure = 0.1, oneDivLambda = ((float)1 / lambda);
	...
	public List<Point> points = new ArrayList<Point>(); //Point to used in the plot
	...
	private void arrival_to_a() {
		...
		nbrOfA++;
		insertEvent(ARRIVAL_TO_A, time + randomExpCalc(oneDivLambda));
	}
	...
	private void measure(){
		...
		noMeasurements++;
		points.add(new Point(nbrOfA, nbrOfB)); //Store data for plot
